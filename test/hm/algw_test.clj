  ...
  (testing "inference normal types"
    (let [fun-id    (EAbs "x" (EVar "x"))
          ...
          expr47    (ECall (EVar "single")
                           [(EVar "id")])
          expr48    (EApp (EVar "id") (EVar "wrong"))
          expr49    (EApp (EVar "cons") (EVar "wrong"))
          expr50    (EApp (EVar "head") (EVar "wrong"))
          expr51    (ECall (EVar "single") [(EVar "wrong")])
          expr52    (EApp (EVar "first") (EVar "wrong"))
          expr53    (EApp (EVar "head") (EApp (EApp (EVar "cons")
                                                    (EVar "zero"))
                                              (EVar "nil")))
          expr54    (EApp (EVar "head") (EVar "zero"))
          expr55    (EApp (EVar "id") (EVar "id"))]
      ...
      (is= (s-of-t (generalize {} (infer assumptions expr32)))
           (s-of-t (generalize {} (infer assumptions expr33)))
      ...
      (is= (s-of-t (generalize {} (infer assumptions expr48))) "∀a. a")
      (is= (s-of-t (generalize {} (infer assumptions expr49))) "∀a. [a] → [a]")
      (is= (s-of-t (generalize {} (infer assumptions expr50))) "∀a. a")
      (is= (s-of-t (generalize {} (infer assumptions expr51))) "∀a. [a]")
      (is= (s-of-t (generalize {} (infer assumptions expr52))) "∀a. a")
      (is= (s-of-t (generalize {} (infer assumptions expr53))) "int")
      (is= (s-of-t (generalize {} (infer assumptions expr54)))
           "types do not unify: [a] vs. int in head zero")
      (is= (s-of-t (generalize {} (infer assumptions expr55))) "∀a. a → a")))
